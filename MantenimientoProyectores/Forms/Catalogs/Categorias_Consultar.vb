...
Public Class Categorias_Consultar
    Dim connection As New MySqlConnection(s)
    Dim command As New MySqlCommand
    Dim lector As MySqlDataReader
    Dim tabla As String = "CATEGORIA"
    Dim idtabla As String = "idCategoria"
    ...
    Private Sub updateDgv()
        ...
        lector = command.ExecuteReader()
        While lector.Read
            dgv.Rows.Add(lector.GetValue(0), lector.GetValue(1))
        End While
        lector.Close()
    ...
    Private Sub SelectedRowChanged()
        ...
        txtConcepto.Text = dgv.Rows(dgv.CurrentCell.RowIndex).Cells(1).Value
    End Sub
