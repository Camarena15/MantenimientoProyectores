...
Public Class Recursos_Consultar
    Dim connection As New MySqlConnection(s)
    Dim command As New MySqlCommand
    Dim lector As MySqlDataReader
    Dim tabla As String = "RECURSOS"
    Dim idtabla As String = "idRecursos"
    ...
    Private Sub updateDgv()
        ...
        lector = command.ExecuteReader()
        While lector.Read
            dgv.Rows.Add(lector.GetValue(0), lector.GetValue(1), lector.GetValue(2))
        End While
        lector.Close()
    End Sub
    ...
    Private Sub SelectedRowChanged()
        ...
        txtDescripcion.Text = dgv.Rows(dgv.CurrentCell.RowIndex).Cells(1).Value
        txtidcat.Text = dgv.Rows(dgv.CurrentCell.RowIndex).Cells(2).Value
    End Sub
