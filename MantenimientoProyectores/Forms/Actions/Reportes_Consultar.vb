...
Public Class Reportes_Consultar
    Dim connection As New MySqlConnection(s)
    Dim command As New MySqlCommand
    Dim lector As MySqlDataReader
    Dim tabla As String = "REPORTEDOCENTES"
    Dim idtabla As String = "IdReporte"
    ...
    Private Sub SelectedRowChanged()
        ...
        txtDocente.Text = DGV.Rows(DGV.CurrentCell.RowIndex).Cells(1).Value
        ...
        txtHoraI.Text = DGV.Rows(DGV.CurrentCell.RowIndex).Cells(5).Value
        txtHoraF.Text = DGV.Rows(DGV.CurrentCell.RowIndex).Cells(6).Value
